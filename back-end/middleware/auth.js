...
module.exports = (req, res, next) => {
  ...
  try {
    ...
    // sinon execution du middleware suivant
      ...
      req.userId = decodedToken.id; // Ajoute l'user id à l'objet req, pour pouvoir l'utiliser dans le middleware suivant
      req.userRole = decodedToken.role;// Ajoute le role à l'objet req, pour pouvoir l'utiliser dans le middleware suivant
      next();
    }
